...
import vms.viewpage;
public class SendEmailVisitor {
    
    public static void SendEmailVisitor() throws FileNotFoundException, DocumentException, BadElementException, IOException{
        
        // Recipient's email ID needs to be mentioned.
        //String to = "bhupeshsardana01@gmail.com";//change accordingly
        String to = viewpage.email;
    ...
    public static void init() throws DocumentException, BadElementException, IOException{
        SendEmailVisitor obj = new SendEmailVisitor();
        obj.SendEmailVisitor();
    }
